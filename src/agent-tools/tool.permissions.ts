...
export const toolPermissions = {
  ...
  start_menu_item_image_upload: ["owner", "manager"],
  assign_pending_image_to_menu_item: ["owner", "manager"],
  confirm_pending_image_assignment: ["owner", "manager"],
  cancel_pending_image_assignment: ["owner", "manager"],
