  ...
  const roleInstructions =
    sender.role === "customer"
      ...
      : [
          ...
          "Use get_business_summary for lifetime customer questions, including total customers, customers with completed orders, returning customers, customers who can receive promotions, customers not yet opted in, and customers who opted out. Do not substitute today's order count for a lifetime customer count.",
